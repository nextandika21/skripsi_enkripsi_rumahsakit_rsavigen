    ...
    <div class="grid_12 full_block">
        <div class="widget_wrap">
            ...
            <div class="widget_content">
                <form action="/console/patient/add" method="POST" class="form_container left_label" autocomplete="off">
                    @csrf
                    <ul>
                        <li>
                            <div class="form_grid_12">
                                ...
                                <div class="form_input">
                                    <input name="nik" type="text" tabindex="1" class="limiter" required/>
                                    @if($errors->has('nik'))
                                        <span class="input_instruction red">{{$errors->first('nik')}}</span>
                                    @endif
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="form_grid_12">
                                ...
                                <div class="form_input">
                                    <span>
										<input name="jenis_kelamin" class="radio" type="radio" value="Pria" tabindex="10">
										<label class="choice">Pria</label>
                                    </span>
                                    <span>
										<input name="jenis_kelamin" class="radio" type="radio" value="Wanita" tabindex="10">
                        ...
                        <li>
                            <div class="form_grid_12">
                                ...
                                <div class="form_input">
                                    <textarea name="alamat" class="input_grow" cols="80" rows="5" tabindex="5" required></textarea>
                        ...
                        <li>
                            <div class="form_grid_12">
                                ...
                                <div class="form_input">
                                    <input name="nomor_hp" type="text" id="mobile" required/>
